...
```sh
pip install git+https://github.com/TimeLogic-API-LLC/timelogic-api.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/TimeLogic-API-LLC/timelogic-api.git`)
