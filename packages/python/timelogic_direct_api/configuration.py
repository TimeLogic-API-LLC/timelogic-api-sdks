...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "directBearerAuth": BearerFormatAuthSetting,
        "directApiKeyHeader": APIKeyAuthSetting,
        "directApiKeyQuery": APIKeyAuthSetting,
...
conf = timelogic_direct_api.Configuration(
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if 'directApiKeyHeader' in self.api_key:
            auth['directApiKeyHeader'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-API-Key',
        ...
        if 'directApiKeyQuery' in self.api_key:
            auth['directApiKeyQuery'] = {
                'type': 'api_key',
                'in': 'query',
                'key': 'api_key',
                'value': self.get_api_key_with_prefix(
