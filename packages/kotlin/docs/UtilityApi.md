...
try {
    ...
    println("4xx response calling UtilityApi#getPublicSigningKey")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling UtilityApi#getPublicSigningKey")
    e.printStackTrace()
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **kid** | **kotlin.String**| Optional signing key identifier filter, for example &#x60;ed25519-2026-07-19&#x60;. When present, the response returns only the matching retained public key. | [optional] |
