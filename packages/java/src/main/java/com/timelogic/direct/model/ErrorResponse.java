...
public class ErrorResponse {
  ...
  public ErrorResponse error(@javax.annotation.Nonnull ApiError error) {
    this.error = error;
    return this;
  }
  ...
  public ErrorResponse requestId(@javax.annotation.Nonnull String requestId) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(error, requestId, timestamp);
  }
