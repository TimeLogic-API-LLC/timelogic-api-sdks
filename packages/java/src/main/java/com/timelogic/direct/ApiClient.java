...
public class ApiClient {
    ...
    new ServerConfiguration(
      "https://{host}",
      "Default direct customer API host; override `host` for a customer-specific domain or subdomain.",
    ...
    public ApiClient() {
        ...
        authentications.put("directBearerAuth", new HttpBearerAuth("bearer"));
        authentications.put("directApiKeyHeader", new ApiKeyAuth("header", "X-API-Key"));
        authentications.put("directApiKeyQuery", new ApiKeyAuth("query", "api_key"));
