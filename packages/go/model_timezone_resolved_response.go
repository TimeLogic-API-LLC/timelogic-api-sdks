...
// checks if the TimezoneResolvedResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimezoneResolvedResponse{}

// TimezoneResolvedResponse Standard single-target timezone resolution payload.
type TimezoneResolvedResponse struct {
...
type _TimezoneResolvedResponse TimezoneResolvedResponse
...
func (o TimezoneResolvedResponse) MarshalJSON() ([]byte, error) {
...
func (o TimezoneResolvedResponse) ToMap() (map[string]interface{}, error) {
...
func (o *TimezoneResolvedResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varTimezoneResolvedResponse := _TimezoneResolvedResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTimezoneResolvedResponse)

	if err != nil {
		return err
	}

	*o = TimezoneResolvedResponse(varTimezoneResolvedResponse)

	return err
}

type NullableTimezoneResolvedResponse struct {
	value *TimezoneResolvedResponse
	isSet bool
}

func (v NullableTimezoneResolvedResponse) Get() *TimezoneResolvedResponse {
	return v.value
}

func (v *NullableTimezoneResolvedResponse) Set(val *TimezoneResolvedResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTimezoneResolvedResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTimezoneResolvedResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimezoneResolvedResponse(val *TimezoneResolvedResponse) *NullableTimezoneResolvedResponse {
	return &NullableTimezoneResolvedResponse{value: val, isSet: true}
}

func (v NullableTimezoneResolvedResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimezoneResolvedResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
