...
## Overview
This API client was generated by the [TimeLogic API SDK generator](https://github.com/TimeLogic-API-LLC/timelogic-api-sdks.git) project.  By using the [OpenAPI-spec](https://www.openapis.org/) from a remote server, you can easily generate an API client.
