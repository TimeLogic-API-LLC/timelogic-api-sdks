...
open class UtilityAPI {
     ...
     */
    @discardableResult
    open class func getPublicSigningKey(kid: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: JwksResponse?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getPublicSigningKeyWithRequestBuilder(kid: String? = nil) -> RequestBuilder<JwksResponse> {
        ...
        let localVariableRequestBuilder: RequestBuilder<JwksResponse>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
