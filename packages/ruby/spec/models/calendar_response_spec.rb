...
# Unit tests for TimeLogic::DirectApi::CalendarResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TimeLogic::DirectApi::CalendarResponse do
  let(:instance) { TimeLogic::DirectApi::CalendarResponse.new }

  describe 'test an instance of CalendarResponse' do
    it 'should create an instance of CalendarResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TimeLogic::DirectApi::CalendarResponse)
    end
  end
