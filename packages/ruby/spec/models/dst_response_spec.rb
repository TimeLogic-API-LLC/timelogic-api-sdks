...
# Unit tests for TimeLogic::DirectApi::DstResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TimeLogic::DirectApi::DstResponse do
  let(:instance) { TimeLogic::DirectApi::DstResponse.new }

  describe 'test an instance of DstResponse' do
    it 'should create an instance of DstResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TimeLogic::DirectApi::DstResponse)
    end
  end
