...
# Unit tests for TimeLogic::DirectApi::BulkError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TimeLogic::DirectApi::BulkError do
  let(:instance) { TimeLogic::DirectApi::BulkError.new }

  describe 'test an instance of BulkError' do
    it 'should create an instance of BulkError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TimeLogic::DirectApi::BulkError)
    end
  end
