...
# Unit tests for TimeLogic::DirectApi::TimePayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TimeLogic::DirectApi::TimePayload do
  let(:instance) { TimeLogic::DirectApi::TimePayload.new }

  describe 'test an instance of TimePayload' do
    it 'should create an instance of TimePayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TimeLogic::DirectApi::TimePayload)
    end
  end
