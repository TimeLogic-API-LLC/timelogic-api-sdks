...
# Unit tests for TimeLogic::DirectApi::TimezoneMatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TimeLogic::DirectApi::TimezoneMatch do
  let(:instance) { TimeLogic::DirectApi::TimezoneMatch.new }

  describe 'test an instance of TimezoneMatch' do
    it 'should create an instance of TimezoneMatch' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TimeLogic::DirectApi::TimezoneMatch)
    end
  end
