...
# Unit tests for TimeLogic::DirectApi::ElapsedResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TimeLogic::DirectApi::ElapsedResponse do
  let(:instance) { TimeLogic::DirectApi::ElapsedResponse.new }

  describe 'test an instance of ElapsedResponse' do
    it 'should create an instance of ElapsedResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TimeLogic::DirectApi::ElapsedResponse)
    end
  end
