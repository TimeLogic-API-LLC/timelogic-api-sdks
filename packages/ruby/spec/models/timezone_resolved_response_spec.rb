...
# Unit tests for TimeLogic::DirectApi::TimezoneResolvedResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TimeLogic::DirectApi::TimezoneResolvedResponse do
  let(:instance) { TimeLogic::DirectApi::TimezoneResolvedResponse.new }
  ...
  describe 'test an instance of TimezoneResolvedResponse' do
    it 'should create an instance of TimezoneResolvedResponse' do
      ...
      #expect(instance).to be_instance_of(TimeLogic::DirectApi::TimezoneResolvedResponse)
    end
  end
