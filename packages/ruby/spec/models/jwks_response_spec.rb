...
# Unit tests for TimeLogic::DirectApi::JwksResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TimeLogic::DirectApi::JwksResponse do
  let(:instance) { TimeLogic::DirectApi::JwksResponse.new }

  describe 'test an instance of JwksResponse' do
    it 'should create an instance of JwksResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TimeLogic::DirectApi::JwksResponse)
    end
  end
