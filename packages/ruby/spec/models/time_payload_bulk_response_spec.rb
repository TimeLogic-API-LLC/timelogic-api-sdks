...
# Unit tests for TimeLogic::DirectApi::TimePayloadBulkResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TimeLogic::DirectApi::TimePayloadBulkResponse do
  let(:instance) { TimeLogic::DirectApi::TimePayloadBulkResponse.new }
  ...
  describe 'test an instance of TimePayloadBulkResponse' do
    it 'should create an instance of TimePayloadBulkResponse' do
      ...
      #expect(instance).to be_instance_of(TimeLogic::DirectApi::TimePayloadBulkResponse)
    end
  end
