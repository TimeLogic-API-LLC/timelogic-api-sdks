...
module TimeLogic::Api
  class DiffResponse
    ...
    def valid?
      ...
      direction_validator = EnumAttributeValidator.new('String', ["forward", "backward", "same"])
    ...
    def direction=(direction)
      validator = EnumAttributeValidator.new('String', ["forward", "backward", "same"])
    ...
    def hash
      [seconds, minutes, hours, days, direction, human, formatted, business_days, from, to].hash
    end
