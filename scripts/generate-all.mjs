...
const properties = {
  typescript: 'npmName=@timelogic/direct-api,npmVersion=0.1.0,supportsES6=true,useSingleRequestParameter=true,generateAliasAsModel=true,gitUserId=TimeLogic-API-LLC,gitRepoId=timelogic-api-sdks',
  python: 'packageName=timelogic_direct_api,projectName=timelogic-direct-api,packageVersion=0.1.0,generateAliasAsModel=true,gitUserId=TimeLogic-API-LLC,gitRepoId=timelogic-api-sdks',
  rust: 'packageName=timelogic-direct-api,packageVersion=0.1.0,generateAliasAsModel=true,gitUserId=TimeLogic-API-LLC,gitRepoId=timelogic-api-sdks',
